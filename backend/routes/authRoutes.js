...
// NEW: Session-based auth middleware (DB-backed sessions)
const sessionAuth = require('../middlewares/sessionAuth');

/**
 * Prefer Session token; fallback to JWT.
 * - If request carries a session token (Authorization: "Session <token>" OR cookie "session_token"),
 *   authenticate via sessionAuth.
 * - Otherwise, use existing JWT authMiddleware.
 */
